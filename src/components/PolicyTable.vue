    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-sm-9 ml-sm-auto col-md-10 pt-3 main-content" role="main">
                ...
                <a class="fa fa-question-circle color-primary doc-link" v-b-tooltip.hover title="Click here for more info about this page" href="https://smartdevicelink.com/en/docs/sdl-server/master/user-interface/view-policy-table/"></a>
