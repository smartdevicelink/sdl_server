        ...
        <div class="row">
            ...
            <div class="col-sm-9 ml-sm-auto col-md-10 pt-3 main-content">
                ...
                <div class="functional-content">
                    <h4>Consumer Message {{ message.is_deleted ? "(deleted)" : "" }} <a class="fa fa-question-circle" v-b-tooltip.hover title="Click here for more info about this page" href="https://smartdevicelink.com/en/docs/sdl-server/master/user-interface/messages-and-functional-groups/"></a></h4>
