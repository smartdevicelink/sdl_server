...
module.exports = {
    ...
    dbModule: "postgres",
    dbUser: process.env.PG_USER || null,
    dbDatabase: process.env.PG_DATABASE || null,
    dbPassword: process.env.PG_PASSWORD || null,
    dbHost: process.env.PG_HOST || null,
    dbPort: process.env.PG_PORT || null,
