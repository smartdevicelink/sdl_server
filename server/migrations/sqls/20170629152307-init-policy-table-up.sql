...
(null, 'de-de', 'nicht autorisiert', null, 'AppUnauthorized', null, 'Diese Version von %appName% ist nicht autorisiert und wird nicht mit SYNC funktionieren.'),
(null, 'en-au', 'not authorized', null, 'AppUnauthorized', null, 'This version of %appName% is not authorized and will not work with SYNC.'),
(null, 'en-gb', 'not authorized', null, 'AppUnauthorized', 'This version of %appName% is not authorized and will not work with SYNC.', 'This version of %appName% is not authorized and will not work with SYNC.'),
(null, 'en-ie', 'not authorized', null, 'AppUnauthorized', null, 'This version of %appName% is not authorized and will not work with SYNC.'),
(null, 'en-us', 'Not Authorized', null, 'AppUnauthorized', 'This version of %appName% is no longer authorized to work with AppLink. Please update to the latest version of %appName%.', 'This version of %appName% is not authorized and will not work with SYNC.'),
(null, 'es-en', 'no autorizada', null, 'AppUnauthorized', 'Esta versión de %appName% no tiene autorización y no funcionará con SYNC.', 'Esta versión de %appName% no tiene autorización y no funcionará con SYNC.'),
(null, 'es-es', 'No autorizada', null, 'AppUnauthorized', null, 'Esta versión de %appName% no está autorizada y no funcionará con SYNC.'),
(null, 'es-mx', 'no autorizada', null, 'AppUnauthorized', 'Esta versión de %appName% no tiene autorización y no funcionará con SYNC.', 'Esta versión de %appName% no tiene autorización y no funcionará con SYNC.'),
(null, 'fr-ca', 'non autorisée', null, 'AppUnauthorized', 'Cette version de %appName% n’est pas autorisée et ne fonctionnera pas avec SYNC.', 'Cette version de %appName% n’est pas autorisée et ne fonctionnera pas avec SYNC.'),
(null, 'fr-fr', 'non autorisée', null, 'AppUnauthorized', null, 'Cette version de %appName% n’est pas autorisée et ne fonctionnera pas avec SYNC.'),
(null, 'it-it', 'non autorizzata', null, 'AppUnauthorized', null, 'Questa versione di %appName% non è autorizzata e non funziona con il SYNC.'),
(null, 'nl-nl', 'niet geautoriseerd', null, 'AppUnauthorized', null, 'Deze versie van %appName% is niet geautoriseerd en werkt niet met SYNC.'),
(null, 'pl-pl', 'brak autoryzacji', null, 'AppUnauthorized', null, 'Niniejsza wersja %appName% nie posiada autoryzacji i nie będzie działać z SYNC.'),
(null, 'pt-br', 'não autorizado', null, 'AppUnauthorized', null, 'Esta versão do %appName% não tem autorização e não funcionará com o SYNC.'),
(null, 'pt-pt', 'não autorizada', null, 'AppUnauthorized', null, 'Esta versão de %appName% não está autorizada e não funcionará com o SYNC.'),
(null, 'ru-ru', 'не авторизировано', null, 'AppUnauthorized', null, 'Эта версия %appName% не авторизирована и не будет работать с SYNC.'),
(null, 'sv-se', 'är ej godkänd', null, 'AppUnauthorized', null, 'Den här versionen av %appName% är inte godkänd och fungerar inte med SYNC.'),
(null, 'tr-tr', 'için izin yok', null, 'AppUnauthorized', null, 'Bu %appName% sürümüne izin verilmediğinden SYNC ile çalışamaz.'),
(null, 'zh-cn', '未得到授权', null, 'AppUnauthorized', null, '此版本的%appName% 未得到授权，无法在SYNC上使用。'),
(null, 'zh-tw', '無授權', null, 'AppUnauthorized', null, '%appName% 的版本未獲得授權，將無法透過 SYNC 使用。'),
(null, 'de-de', 'nicht unterstützt', null, 'AppUnsupported', null, 'Diese Version von %appName% wird von SYNC nicht unterstützt.'),
(null, 'en-au', 'not supported', null, 'AppUnsupported', null, 'This version of %appName% is not supported by SYNC.'),
(null, 'en-gb', 'not supported', null, 'AppUnsupported', 'This version of %appName% is not supported by SYNC.', 'This version of %appName% is not supported by SYNC.'),
(null, 'en-ie', 'not supported', null, 'AppUnsupported', null, 'This version of %appName% is not supported by SYNC.'),
(null, 'en-us', 'Not Supported', null, 'AppUnsupported', 'Your version of %appName% is not supported by SYNC.', 'This version of %appName% is not supported by SYNC.'),
(null, 'es-en', 'no compatible', null, 'AppUnsupported', 'Esta versión de %appName% no es compatible con SYNC.', 'Esta versión de %appName% no es compatible con SYNC.'),
(null, 'es-es', 'No compatible', null, 'AppUnsupported', null, 'Esta versión de %appName% no es compatible con SYNC.'),
(null, 'es-mx', 'no compatible', null, 'AppUnsupported', 'Esta versión de %appName% no es compatible con SYNC.', 'Esta versión de %appName% no es compatible con SYNC.'),
(null, 'fr-ca', 'incompatible', null, 'AppUnsupported', 'Cette version de %appName% n’est pas prise en charge par SYNC.', 'Cette version de %appName% n’est pas prise en charge par SYNC.'),
(null, 'fr-fr', 'incompatible', null, 'AppUnsupported', null, 'Cette version de %appName% n’est pas prise en charge par SYNC.'),
(null, 'it-it', 'non supportata', null, 'AppUnsupported', null, 'Questa versione di %appName% non è supportata dal SYNC.'),
(null, 'nl-nl', 'niet ondersteund', null, 'AppUnsupported', null, 'Deze versie van %appName% wordt niet ondersteund door SYNC.'),
(null, 'pl-pl', 'aplikacja nie obsług.', null, 'AppUnsupported', null, 'Niniejsza wersja %appName% nie jest obsługiwana przez system SYNC.'),
(null, 'pt-br', 'não suportado', null, 'AppUnsupported', null, 'Esta versão do %appName% não é suportada pelo SYNC.'),
(null, 'pt-pt', 'não suportada', null, 'AppUnsupported', null, 'Esta versão de %appName% não é suportado pelo SYNC.'),
(null, 'ru-ru', 'не поддерживается', null, 'AppUnsupported', null, 'Эта версия %appName% не поддерживается SYNC.'),
(null, 'sv-se', 'stöds ej', null, 'AppUnsupported', null, 'SYNC har inte stöd för den här versionen av %appName%.'),
...
(null, 'de-de', 'Auto-Update', 'und Mobile Apps deaktivieren', 'DisableApps', null, 'Ausschalten der automatischen Updates führt zum Ausschalten von SYNC mobile Apps. Sie können Ihre mobilen Apps dann nicht mehr mit SYNC nutzen. Bitte drücken Sie Ja zur Bestätigung oder Nein, um abzubrechen.'),
(null, 'en-au', 'Disable auto-updates', 'and Mobile Apps?', 'DisableApps', null, 'Disabling automatic updates will also disable SYNC mobile apps. You will not be able to use any mobile apps with SYNC. Please press Yes to confirm or No to cancel.'),
...
(null, 'en-ie', 'Disable auto-updates', 'and Mobile Apps?', 'DisableApps', null, 'Disabling automatic updates will also disable SYNC mobile apps. You will not be able to use any mobile apps with SYNC. Please press Yes to confirm or No to cancel.'),
(null, 'en-us', 'Disable Auto-Updates', 'and Mobile Apps?', 'DisableApps', 'If you disable, you will not be able to use any mobile apps with SYNC and your vehicle will stop receiving mobile app permission updates via your device`s data plan. Please press yes to disable mobile apps or no to cancel.', 'Disabling automatic updates will also disable sync mobile apps. You will not be able to use any mobile apps with SYNC. Please press yes to confirm or no to cancel.'),
(null, 'es-en', '¿Deshab. actualiz.', 'autom. y aplic. móv.?', 'DisableApps', 'Si se desactivan las actualizaciones automáticas, también se desactivarán las aplicaciones móviles de SYNC. No podrá usar ninguna aplicación móvil con SYNC. Presione Sí para confirmar o No para cancelar.', 'Si se desactivan las actualizaciones automáticas, también se desactivarán las aplicaciones móviles de SYNC. No podrá usar ninguna aplicación móvil con SYNC. Presione Sí para confirmar o No para cancelar.'),
(null, 'es-es', '¿Desact. actual. auto', 'y apl. móviles?', 'DisableApps', null, 'Si desactiva las actualizaciones automáticas, también se desactivará la sincronización de las aplicaciones móviles. No podrá utilizar ninguna aplicación móvil con SYNC. Pulse sí para confirmar o no para cancelar.'),
(null, 'es-mx', '¿Deshab. actualiz.', 'autom. y aplic. móv.?', 'DisableApps', 'Si se desactivan las actualizaciones automáticas, también se desactivarán las aplicaciones móviles de SYNC. No podrá usar ninguna aplicación móvil con SYNC. Presione Sí para confirmar o No para cancelar.', 'Si se desactivan las actualizaciones automáticas, también se desactivarán las aplicaciones móviles de SYNC. No podrá usar ninguna aplicación móvil con SYNC. Presione Sí para confirmar o No para cancelar.'),
(null, 'fr-ca', 'Désactiver màj autom.', 'et app. mobiles?', 'DisableApps', 'La désactivation des mises à jour automatiques désactivera aussi les applications mobiles SYNC. Vous ne pourrez pas utiliser d’application mobile avec SYNC. Veuillez appuyer sur Oui pour confirmer ou sur Non pour annuler.', 'La désactivation des mises à jour automatiques désactivera aussi les applications mobiles SYNC. Vous ne pourrez pas utiliser d’application mobile avec SYNC. Veuillez appuyer sur Oui pour confirmer ou sur Non pour annuler.'),
(null, 'fr-fr', 'Désactiver màj autom.', 'et app. mobiles?', 'DisableApps', null, 'La désactivation des mises à jour automatiques désactivera aussi les applications mobiles SYNC. Vous ne pourrez pas utiliser d’application mobile avec SYNC. Veuillez appuyer sur Oui pour confirmer ou sur Non pour annuler.'),
(null, 'it-it', 'Disabilitare agg. aut.', 'e app mobili?', 'DisableApps', null, 'Disabilitando gli aggiornamenti automatici si disattiva anche la sincronizzazione delle app mobili. Non sarà possibile usare app mobili con il SYNC. Premere Sì per confermare e No per cancellare.'),
(null, 'nl-nl', 'Auto-updates en mob.', 'apps uitschakelen?', 'DisableApps', null, 'Door automatische updates uit te schakelen, schakelt u ook SYNC-mobiele apps uit. U kunt dan geen mobiele apps meer gebruiken met SYNC. Druk op Ja om te bevestigen of op Nee om te annuleren.'),
(null, 'pl-pl', 'Wył. automat. aktual.', 'i aplikacje mobilne?', 'DisableApps', null, 'Wyłączenie automatycznych aktualizacji spowoduje także wyłączenie aplikacji mobilnych SYNC. Korzystanie z mobilnych aplikacji za pomocą SYNC będzie niemożliwe. Naciśnij TAK, by potwierdzić lub NIE, by anulować.'),
(null, 'pt-br', 'Desativar atualizações', 'autom. e aplicativos?', 'DisableApps', null, 'Se as atualizações automáticas forem desativadas, os aplicativos também serão desativados. Você não poderá usar nenhum aplicativo com o SYNC. Pressione sim para confirmar ou não para cancelar.'),
(null, 'pt-pt', 'Desact. actual. autom.', 'e aplicações móveis?', 'DisableApps', null, 'A desactivação das actualizações automáticas desactiva igualmente as aplicações móveis do SYNC. Não poderá utilizar quaisquer aplicações móveis com o SYNC. Prima ""Sim"" para confirmar ou ""Não"" para cancelar.'),
(null, 'ru-ru', 'Откл. автообновления', 'и мобил. прилож.?', 'DisableApps', null, 'При отключении автоматических обновлений также будут отключены мобильные приложения sync. Вы не сможете использовать какие-либо мобильные приложения с SYNC. Нажмите ""Да"" для подтверждения или ""Нет"" для отмены.'),
(null, 'sv-se', 'Avaktiverar autouppdat.', 'och mobilappar?', 'DisableApps', null, 'Om du avaktiverar automatisk uppdatering avaktiverar du även synkning av mobilappar. Du kommer inte längre att kunna använda dina mobilappar med SYNC. Tryck Ja för att bekräfta eller Nej för att avbryta.'),
(null, 'tr-tr', 'Oto. güncelleme ve', 'mobil uygul. kapat?', 'DisableApps', null, 'Otomatik güncellemeleri devre dışı bırakırsanız sync mobil uygulamalar da devre dışı kalır. SYNC ile mobil uygulama kullanmanız mümkün olmaz. Lütfen onaylamak için Evet''e veya iptal etmek için Hayır''a basın.'),
(null, 'zh-cn', '是否禁用自动更新和', '移动应用程序？', 'DisableApps', null, '禁用自动更新同时也会禁用SYNC移动应用程序。您将无法在 SYNC 中使用任何移动应用程序。请按“是”确认或按“否”取消。'),
(null, 'zh-tw', '停用自動更新', '和行動應用程式？', 'DisableApps', null, '停用自動更新也將停用 sync 行動應用程式。您將無法透過 SYNC 使用任何行動應用程式。確認請按「是」，取消請按「否」。'),
...
(null, 'en-us', 'Request Update', null, 'SettingUpdateAuto', 'Select `Update now` to receive app permissions for your SYNC-enabled mobile apps. This may enable additional functionality depending on the app and your settings. If your phone has a working data connection, an update should complete in less than 1 minute.', null),
