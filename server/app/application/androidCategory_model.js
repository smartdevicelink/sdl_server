...
module.exports = function(app, db, config) {
	 ...
	 */
	var AndroidCategory = new Schema({
	...
	AndroidCategory.pre('save', function(next) {
	 ...
	 */
	AndroidCategory.methods.sanitize = function() {
		return this;
	};
	...
	AndroidCategory.plugin(model.crudPlugin);

	/* ************************************************** *
	 * ******************** Export Schema(s)
	 * ************************************************** */

	db.model('AndroidCategory', AndroidCategory);
};
