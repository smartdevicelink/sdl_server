...
SELECT id AS function_group_id, 'GetVehicleData' AS rpc_name, 'stabilityControlsStatus' AS parameter
...
WHERE property_name = 'VehicleInfo-3'
    AND NOT EXISTS(
        ...
        WHERE property_name = 'VehicleInfo-3'
            AND parameter = 'stabilityControlsStatus'
            AND rpc_name = 'GetVehicleData'
    );

INSERT INTO function_group_parameters(function_group_id, rpc_name, parameter)
SELECT id AS function_group_id, 'OnVehicleData' AS rpc_name, 'stabilityControlsStatus' AS parameter
FROM function_group_info
WHERE property_name = 'VehicleInfo-3'
    AND NOT EXISTS(
        SELECT 1
...
INSERT INTO function_group_parameters(function_group_id, rpc_name, parameter)
SELECT id AS function_group_id, 'SubscribeVehicleData' AS rpc_name, 'stabilityControlsStatus' AS parameter
FROM function_group_info
WHERE property_name = 'VehicleInfo-3'
    AND NOT EXISTS(
        SELECT 1
...
INSERT INTO function_group_parameters(function_group_id, rpc_name, parameter)
SELECT id AS function_group_id, 'UnsubscribeVehicleData' AS rpc_name, 'stabilityControlsStatus' AS parameter
FROM function_group_info
WHERE property_name = 'VehicleInfo-3'
    AND NOT EXISTS(
        SELECT 1
