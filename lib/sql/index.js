...
function getMessageGroups (isProduction, category) {
    ...
    sqlString = sqlString.orderBy('message_category');
    ...
    return objs.map(function (obj) {
        return sql.insert('message_text', 'language_id', 'tts', 'line1', 'line2', 'text_body', 'label', 'message_group_id')
            .select
                ...
                `'${doubleQuotes(obj.tts)}' AS tts`,
                `'${doubleQuotes(obj.line1)}' AS line1`,
                `'${doubleQuotes(obj.line2)}' AS line2`,
                `'${doubleQuotes(obj.text_body)}' AS text_body`,
                `'${doubleQuotes(obj.label)}' AS label`,
