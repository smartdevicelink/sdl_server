...
const self = module.exports = {
    webhook: function (req, res, next) {
        ...
        if (req.body.entity === "application") {
            ...
            const applicationFlow = req.app.locals.flow([self.getApplications.bind(null, query), checkResponse, storeApps(req)], {method: "waterfall"});
...
function checkResponse (body, next) {
    console.log("2");
    console.log(body);
