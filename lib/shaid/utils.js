...
function storeApps (includeApprovalStatus) {
    return function (apps, next) {
        ...
        const fullFlow = flow([updateCheckFlow, filterApps, insertApps(includeApprovalStatus)], {method: "waterfall"});
...
function insertApps (includeApprovalStatus) {
    return function (appObjs, next) {
        const insertFlows = appObjs.map(function (appObj) {
            //if includeApprovalStatus is false, ignore the approval_status attribute and use the database default
